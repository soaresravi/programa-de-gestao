  ...
  return (
    <div className={styles.card}>
      <div className={styles.imageContainer}>
        <img 
          src={item.produtoFoto || 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Item_sem_imagem.svg/1280px-Item_sem_imagem.svg.png'} 
          alt={item.produtoNome} 
        />
        <button className={styles.menuButton} onClick={(e) => { e.stopPropagation(); onClick(); }}>
          <Ellipsis size={18} />
        </button>
      </div>
      ...
      <div className={styles.info}>
        ...
        {/* Mostra o valor unitário que vem do sistema */}
